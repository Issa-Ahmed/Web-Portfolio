...
@section('content')
    {{-- Hero section --}}
    <section
        class="h-fit m-auto mt-12  w-5/6 bg-white text-black rounded-lg flex sm:flex-row flex-col gap-y-4 overflow-hidden">
        <h1 class="text-4xl w-2/3 py-16 pl-10 tracking-wider leading-relaxed m-0 overflow-hidden block reveal-animation">
    ...
    <section>
        <div class="grid sm:grid-cols-2 grid-col-1 py-20 px-12 gap-x-12 gap-y-20">
            @foreach ($projectsList as $singleProject)
                <div class="h-[500px] flex flex-col  text-white rounded-lg singleProject" data-aos="fade-up">
                    <div class="pl-4 h-1/5">
                        <h2 class="text-2xl pt-2 font-bold project-name">{{ $singleProject['name'] }}
                        </h2>
